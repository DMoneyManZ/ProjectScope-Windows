...
[Successful private Windows run](https://github.com/DMoneyManZ/ProjectScope-Windows/actions/runs/34557927191), completed September 11, 2026 UTC (September 10 US Eastern).
...
Runtime: Python 3.12.10 x64, PySide6 Essentials/Shiboken 6.11.2. Build tool: PyInstaller 6.22.2. The private release includes the full validation ZIP with package inventory and build dependency versions.
